...
class Rotor:
    ...
    def __run_blade():
        ...
        INPUTS = ca.vcat([Va, Vt, r, R, Rn, V0, ns, rho, sos, viscosity, theta, b, Au, Al, Le, Nb])
        OUTPUS = ca.vcat([dT_dr_blade, dM_dr_blade, dT_dr_Momentum_correct, dM_dr_Momentum_correct, alpha, beta, CL, CD,fai,V_tau,V0,Re,Ma,W])
    ...
    def get_aero(self, V0: float, ns: float, atmos: asb.Atmosphere):
        ...
        INPUTS = ca.hcat([Vas, Vts, rs, Rs, Rns, V0s, nss, rhos, soss, viscositys, thetas, bs, Aus, Als, Les, Nbs]).T
...
if __name__ == "__main__":
    ...
    rotor.setup(nprocess=5,mpi_mothod="openmp")
